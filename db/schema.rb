...
ActiveRecord::Schema[8.0].define(version: 2025_07_28_194943) do
  ...
  create_table "exercise_sets", force: :cascade do |t|
    ...
    t.index ["distance_value"], name: "index_exercise_sets_on_distance_value_and_distance_unit"
  ...
  create_table "workout_logs", force: :cascade do |t|
    ...
    t.text "exercise_context"
    t.string "benchmark_variation"
    t.boolean "is_default_variation", default: false
