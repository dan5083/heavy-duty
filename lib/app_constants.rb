...
WORKOUTS = {
  ...
  shoulders: [
    ...
    "Cable Lateral Raises", "Shrugs", "Cable Rear Delt Flyes", "Handstand Push-Ups",
...
CLAUSE_LIBRARY = {
  ...
  reflection: {
    options: ["kept it smooth", "felt heavy", "perfect form", "next time go heavier", "solid effort", "form broke down", "great pump", "good mind-muscle connection"],
    color: "purple",
